...
export default function pickInstallmentsList(
  ...
  const clusteredInstallments = clusterInstallments(
    installmentsList,
    clusterBy,
  );
 ...
 * @param clusterBy
 */
function pickMaxOptionCount(clusteredInstallments: any[], clusterBy: any) {
  ...
  let [biggestInstallmentsOptionKey] = maxOptions;
